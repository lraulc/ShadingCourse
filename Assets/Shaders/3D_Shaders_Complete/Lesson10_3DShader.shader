Shader "Shader3DCourse/Lesson10_3DShader"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float2 flowDirection = flowMap.rg + _Time.yy * 0.1; 
                ...
                #if NORMAL_MAP_ON
                    float3 normalMapOne = UnpackNormal(tex2D(_NormalMapOne,  flowDirection));
                    float3 finalNormalOne = normalMapOne.r * i.tangent + normalMapOne.g * i.bitangent + normalMapOne.b * i.normal;

                    float3 normalMapTwo = UnpackNormal(tex2D(_NormalMapTwo, flowDirection));
